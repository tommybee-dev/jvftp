 ...
 * 
 * <DL><DT><B>FtpFile AWT browser</B> consist of:
 * <DD>Ftp<B>BrowsePanel</B> <I>(required)</I>
 * <DD>Ftp<B>CommandPanel</B> <I>(optional)</I>
 * <DD>Ftp<B>ConnectPanel</B> <I>(required)</I>
 * <DD>Ftp<B>LoginPanel</B> <I>(required)</I>
 * <DD>Co<B>ConsoleTextArea</B> <I>(optional)</I>
 * <DD>Co<B>StatusPanel</B> <I>(optional)</I></DL>
 * 
 ...
 * @see FtpConnectPanel
 * @see FtpLoginPanel
 * @see CoConsoleTextArea
 * @see CoStatusPanel
 */
public final class FtpBrowsePanel extends CoBrowsePanel {
	FtpEventQueue queue = null;

	/** <P>Creates a new FtpBrowsePanel instance.</P> */
	FtpBrowsePanel(Ftp client) {
		super(client);
